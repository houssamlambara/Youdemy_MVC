...
Register a GET route*/
  public static function get($route, $callback){self::addRoute('GET', $route, $callback); }

    /*
     
Register a POST route*/
  public static function post($route, $callback){self::addRoute('POST', $route, $callback);}
